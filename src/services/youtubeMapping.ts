...
const safeDateStr = (dateStr?: string): string => {
...
export const mapYouTubeToDetailMovie = (video: YouTubeVideoExtended): DetailMovie => {
    return {
        ...
        release_date: safeDateStr(video.publishedAt),
        revenue: 0,
...
export const mapYouTubeToDetailTV = (video: YouTubeVideoExtended, episodes: YouTubeVideo[]): DetailTV => {
    ...
    return {
        ...
        first_air_date: safeDateStr(video.publishedAt),
        ...
        production_countries: [{ iso_3166_1: "US", name: "United States" }],
        seasons: [{
            air_date: safeDateStr(video.publishedAt),
