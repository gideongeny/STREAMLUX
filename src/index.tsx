...
function initializeApp() {
  ...
  window.addEventListener("error", (event) => {
    // Ignore specific Firebase offline errors to prevent React Error Overlay
    if (event.error?.message?.includes("client is offline") ||
      event.message?.includes("client is offline")) {
      event.preventDefault();
      console.warn("Suppressed offline error:", event.error);
      return;
    }
