...
const WatchlistPage: FC = () => {
    ...
    const { isSidebarVisible, toggle: toggleSidebar, marginClass, isMobile } = useSidebar();
    ...
    return (
        <>
            ...
            <div className="flex items-start">
                ...
                <div className={`flex-grow min-h-screen bg-dark p-6 md:p-10 relative z-0 transition-all duration-500`}>
                    <LibraryNav />
                            ...
                            <div className="flex items-center gap-4">
                                {!isSidebarVisible && !isMobile && (
                                    <button
                                        ...
                                        className="p-2.5 rounded-2xl bg-primary text-black shadow-xl hover:scale-110 transition active:scale-95 flex items-center justify-center shrink-0"
                                        title="Show Menu"
                                    >
