      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-6 text-gray-300">
          ...
          <section className="bg-yellow-900/20 border border-yellow-700 rounded-lg p-6">
            <h2 className="text-2xl font-semibold text-yellow-400 mb-3">Legal Compliance & Intermediary Status</h2>
            <p className="text-white">
              StreamLux operates as an Online Intermediary under <strong>Section 81</strong> of the 
              <strong>Copyright and Related Rights Act (Kenya)</strong>. We are a neutral indexing 
              service and do not possess actual knowledge of infringing activity on third-party 
              hosting sites. 
            </p>
