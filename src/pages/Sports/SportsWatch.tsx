...
import LiveBuzz from "../../components/Sports/LiveBuzz";
        ...
        <div className="flex-grow px-[2vw] md:pt-11 pt-0 pb-10">
          {!fixture ? (
            ...
            <>
              ...
              {fixture.status === "live" && (
                <div className="mb-10 bg-[#0A0A0A] rounded-[2.5rem] p-8 border border-white/5 relative overflow-hidden shadow-2xl group transition-all duration-500 hover:border-primary/20">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                    <div>
                      <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight">LIVE PULSE</h2>
                      <p className="text-gray-500 text-sm font-medium mt-1 uppercase tracking-[0.2em]">Real-time Fan Engagement</p>
                    </div>
                  </div>

                  <div className="h-[400px] w-full rounded-2xl bg-black/40 border border-white/5 overflow-hidden relative">
                    <LiveBuzz matchId={fixture.id} />
                  </div>
                  ...
                  <div className="mt-6 flex items-center gap-4 text-xs font-bold text-gray-500 uppercase tracking-widest">
                    ...
                    <span>•</span>
                    <span>Global Reactions Active</span>
                  </div>
                </div>
              )}
