...
const Settings: FunctionComponent<SettingsProps> = () => {
    ...
    const [isAnalyticsEnabled, setIsAnalyticsEnabled] = useState(() =>
        safeStorage.get("analytics_enabled") !== "false"
    );
    ...
    const handleAnalyticsToggle = () => {
        ...
        safeStorage.set("analytics_enabled", String(newState));
        toast.info(`Analytics Tracking ${newState ? "Enabled" : "Disabled"}`, { position: "top-right", autoClose: 1000 });
        if (!newState) {
            // Optional: Call Firebase to disable analytics dynamically if needed
            ...
            <div className="flex min-h-screen">
                ...
                <div className="flex-grow pt-10 md:pl-10 px-6 bg-dark-lighten min-h-screen min-w-0">
                    ...
                    <div className="max-w-2xl">
                        ...
                        <div className="bg-dark p-6 rounded-xl border border-white/5 shadow-lg mb-8">
                            <h2 className="text-xl text-white font-bold mb-4 flex items-center gap-2">
                                <span className="text-primary">🛡️</span> Privacy & Data
                            </h2>
                            <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                                Manage your data and privacy settings in accordance with GDPR and CCPA.
                            </p>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-gray-500 text-xs mt-1">
                                            Help us improve by anonymously tracking app usage.
                                        </p>
                                    </div>
                                    <button
                                        onClick={handleAnalyticsToggle}
                                        className={`w-12 h-6 rounded-full p-1 transition-colors duration-300 ${isAnalyticsEnabled ? "bg-primary" : "bg-gray-700"}`}
                                    >
                                        <div className={`w-4 h-4 bg-white rounded-full transition-transform duration-300 ${isAnalyticsEnabled ? "translate-x-6" : ""}`} />
                                    </button>
                                </div>
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm mb-2">What We Collect</p>
                                    <ul className="list-disc pl-5 text-gray-500 text-xs space-y-1">
                                        <li>Account Info: Name, avatar, and optional bio/DOB.</li>
                                        <li>Watch History: Saved locally and synced to cloud (if signed in).</li>
                                        <li>App Preferences: Themes, language, and playback settings.</li>
                                    </ul>
                                </div>
                                ...
                                <div className="flex flex-col gap-3">
                                    <Link to="/delete-account" className="text-red-400 text-sm hover:underline font-bold w-max">
                                        Delete My Account & Data (Right to Erasure)
                                    </Link>
                                    <div className="flex gap-4">
                                        <Link to="/privacy-policy" className="text-primary text-sm hover:underline w-max">
                                            Privacy Policy
                                        </Link>
                                        <Link to="/user-agreement" className="text-primary text-sm hover:underline w-max">
                                            User Agreement
                                        </Link>
                                    </div>
                                    <p className="text-gray-500 text-xs mt-2">
                                        Data Requests: Contact <a href="mailto:privacy@streamlux.com" className="text-white hover:underline">privacy@streamlux.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
