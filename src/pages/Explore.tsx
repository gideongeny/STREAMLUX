...
const Explore = () => {
  ...
  // Map genre IDs to searchable YouTube keywords
  const GENRE_NAMES: Record<number, string> = {
    28: "action", 12: "adventure", 16: "animation", 35: "comedy", 80: "crime",
    99: "documentary", 18: "drama", 10751: "family", 14: "fantasy", 36: "history",
    27: "horror", 10402: "music", 9648: "mystery", 10749: "romance", 878: "sci-fi",
    53: "thriller", 10752: "war", 37: "western", 10759: "action adventure",
    10762: "kids", 10764: "reality", 10765: "sci-fi fantasy", 10768: "war politics",
  };
  const ytCategory = filters.region ||
    (filters.genres.length > 0 ? GENRE_NAMES[filters.genres[0]] : undefined) ||
    (currentTab === "movie" ? "movies" : "tv shows");

  const { videos: ytVideos, loading: ytLoading } = useYouTubeVideos({
    region: filters.region || undefined,
    category: !filters.region ? ytCategory : undefined,
    type: currentTab,
  });
  ...
  useEffect(() => {
    ...
    const type = urlType || (localStorage.getItem("currentTab") as "movie" | "tv") || "movie";
    // Support both `genre` (new) and `with_genres` (legacy) URL params
    const genres = [
      ...searchParams.getAll("genre").map(Number),
      ...searchParams.getAll("with_genres").map(Number),
    ...
    if (urlType) localStorage.setItem("currentTab", urlType);
  }, [searchParams]);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex md:hidden justify-between items-center mb-5">
          <Link to="/" className="flex gap-2 items-center">
            <p className="text-xl text-white font-black tracking-tighter uppercase italic">
