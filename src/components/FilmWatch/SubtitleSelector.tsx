    ...
    return (
        <div className={`relative ${className}`}>
            ...
            >
                ...
                <span className="sr-only">{currentSubtitle ? currentSubtitle.language : "Subtitles"}</span>
                {currentSubtitle && (
                    <span className="hidden sm:inline text-[10px] uppercase tracking-widest">{currentSubtitle.language}</span>
                )}
            </button>
            {panel}
        </div>
