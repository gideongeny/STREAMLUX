            ...
            {season.episodes.map((episode) => {
              ...
              >
                <button
                  ...
                  className={`flex items-center gap-3 hover:bg-dark-lighten transiton duration-300 rounded-md pl-2 flex-1 text-left ${isUnreleased ? 'opacity-50 cursor-not-allowed hover:bg-transparent' : ''}`}
                ...
                >
                  ...
                  <div className="flex-grow">
                    ...
                    >
                      {episode.name} {isUnreleased && <span className="text-[10px] text-primary italic ml-2 block sm:inline mt-1 sm:mt-0">(Coming Soon)</span>}
                    </p>
                  </div>
                </button>
