...
const SEO: FC<SEOProps> = ({
    ...
    useEffect(() => {
        ...
        let schemaScript = document.querySelector('script[data-id="schema-dynamic"]');
        if (!schemaScript) {
            schemaScript = document.createElement("script");
            schemaScript.setAttribute("type", "application/ld+json");
            schemaScript.setAttribute("data-id", "schema-dynamic");
            document.head.appendChild(schemaScript);
        }
        
        const schema = {
            "@context": "https://schema.org",
            "@type": type === "video.movie" ? "Movie" : type === "video.tv_show" ? "TVSeries" : "WebPage",
            "name": seoTitle,
            ...
            "publisher": {
                ...
                "logo": {
                    "@type": "ImageObject",
                    "url": "https://streamlux.vercel.app/icon.png"
                }
            }
        };
