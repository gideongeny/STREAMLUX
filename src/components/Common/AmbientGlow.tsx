...
const AmbientGlow: FC<AmbientGlowProps> = ({ imageUrl, fallbackColor = "#ff6b35", activeBrand }) => {
    ...
    useEffect(() => {
        ...
        // Use the global primary color variable as the ultimate ambient source
        // This ensures the vibe from the Watch/Detail page propagates to the glow
        if (!imageUrl) {
            setCurrentGlow(`radial-gradient(circle at 50% 30%, var(--color-primary-glow) 0%, transparent 70%)`);
            setIsLoaded(true);
            return;
        }
