...
const Footer: FunctionComponent<FooterProps> = () => {
  ...
  const { marginClass, widthClass } = useSidebar();

  return (
    <footer className={`bg-black/60 backdrop-blur-[40px] text-white mt-16 border-t border-white/[0.04] relative z-20 shadow-[0_-20px_60px_rgba(0,0,0,0.6)] transition-all duration-500 ${marginClass} ${widthClass}`}>
      {/* Main Footer Content */}
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-6">
          {/* About Section */}
          <div>
            <h3 className="text-2xl font-black mb-4 tracking-[0.15em] uppercase sl-text-gradient">StreamLux</h3>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/copyright" className="text-gray-400 hover:text-primary transition">
                  {t('Copyright & Compliance')}
                </Link>
              </li>
              <li>
                <Link to="/copyright#takedown" className="text-red-400 hover:text-red-300 transition font-bold">
                  {t('Report Takedown')}
                </Link>
              </li>
            </ul>
