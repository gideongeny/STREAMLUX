...
const Footer: FunctionComponent<FooterProps> = () => {
  ...
  return (
    <footer className="bg-dark/40 tw-glass text-white mt-8 border-t border-gray-800 relative z-20 w-full shadow-[0_-10px_40px_rgba(0,0,0,0.5)] md:ml-[260px] md:w-[calc(100%-260px)]">
      {/* Main Footer Content */}
