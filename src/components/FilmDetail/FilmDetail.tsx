...
const PLAY_STORE_URL =
  "https://play.google.com/store/apps/details?id=com.streamlux.app.mobile";
...
const FilmDetail: FC<FilmInfo> = ({ similar, videos, detail, ...others }) => {
  ...
  const handleWatchInApp = () => {
    ...
    toast.info("Opening StreamLux on Google Play...", {
      icon: "📱",
  ...
  const showWatchInApp = !Capacitor.isNativePlatform();
                  ...
                  <div className="flex flex-col md:flex-row gap-5 items-start md:items-center">
                    ...
                    {isMobile && (
                      <div className="flex flex-col gap-3 mt-4 ml-3 md:ml-0 w-full pr-6">
                        ...
                        <Link
                            to="watch#download"
                            className="flex gap-2 items-center justify-center px-4 py-3 rounded-full bg-primary/10 text-primary border border-primary/30 hover:bg-primary hover:text-black transition duration-300 w-full font-black uppercase tracking-widest text-sm"
                          >
                  ...
                  {!isMobile && (
                    <div className="flex flex-col gap-4 items-center mt-24">
                      <div className="flex gap-4 items-center">
                        ...
                        <Link
                            to="watch#download"
                            className="flex gap-2 items-center justify-center pl-6 pr-10 py-3.5 rounded-full bg-primary/10 text-primary border border-primary/30 hover:bg-primary hover:text-black transition duration-300 font-black uppercase tracking-widest"
                          >
                            <AiOutlineDownload size={22} />
                            <span className="text-sm tracking-[0.15em]">Download</span>
                          </Link>
                      </div>
