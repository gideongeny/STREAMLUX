...
const crawlToxicWap = async () => {
    try {
        ...
        $('article, .post, .item').each((_, element) => {
            ...
            const quality = (_a = $(element).text().match(/(720p|1080p|HD|CAM)/i)) === null || _a === void 0 ? void 0 : _a[0];
            if (title && href) {
                results.push({
                    title,
...
exports.crawlToxicWap = crawlToxicWap;
