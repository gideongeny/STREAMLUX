...
exports.crawlCoolMovieZ = void 0;
...
const crawlCoolMovieZ = async () => {
    try {
        ...
        $('article, .movie, .post, .item').each((_, element) => {
            ...
            const title = titleElem.text().trim() || ((_a = titleElem.attr('title')) === null || _a === void 0 ? void 0 : _a.trim());
            const href = titleElem.attr('href');
            const quality = (_b = $(element).text().match(/(MP4|720p|1080p|HD)/i)) === null || _b === void 0 ? void 0 : _b[0];
            if (title && href) {
                results.push({
                    title,
...
exports.crawlCoolMovieZ = crawlCoolMovieZ;
